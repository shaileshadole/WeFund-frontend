...
const CampaignDetails = () => {
  ...
  const handleDownloadPDF = () => {
    ...
    pdf.text("Campaign Report", 70, 20);
    pdf.line(20, 47, 160, 47);

    //Subtitle
    pdf.setFontSize(12);
    pdf.setTextColor(100);
    pdf.text(`Title: ${campaign.title}`, 20, 35);
    pdf.text(`End Date: ${new Date().toLocaleDateString()}`, 20, 45);
    pdf.line(20, 47, 180, 47);

    //Campaign Description
    pdf.setFontSize(14);
    pdf.setTextColor(0);
    pdf.text("Campaign Details", 20, 60);

    // Campaign Description (wrapped)
    pdf.setFontSize(12);
    ...
    // Move Y after description
    currentY += splitDescription.length * 5; // 7mm per line approx

    //Normal Text
    pdf.setFontSize(12);
    pdf.text(`Target Amount: ${campaign.target} Rs.`, 20, currentY + 10);
    pdf.text(
      `Raised Amount: ${campaign.donatedTillNow} Rs.`,
      20,
      currentY + 20
    );
    pdf.line(20, currentY + 22, 180, currentY + 22);

    //Table-like Structure
    pdf.setFontSize(14);
    pdf.text("Donations", 20, currentY + 40);
    ...
    pdf.text("Generated by WeFund Crowdfunding Platform", 20, 280);

    //save File
    pdf.save(`${campaign.title.replace(/\s+/g, "_")}campaign.pdf`);
  };
